...
class JenisTanahDatatable extends DataTable
{
    public function dataTable($query)
    {
        return DataTables::of($query)
            ...
            ->addColumn('id_jenis_tanah', function ($data) {
                return $data->jenistanah->name;
            })
            ...
            ->addColumn('action', function ($data) {
                ...
                if (Gate::check('jenistanah-U')) {
                    $action .= $edit;
                }
            
                if (Gate::check('jenistanah-D')) {
                    $action .= $delete;
                }
            
                return $action;
            })
            ->rawColumns(['kota', 'id_jenis_tanah', 'luas', 'action']);
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('id_jenis_tanah')->title('Jenis Tanah'),
