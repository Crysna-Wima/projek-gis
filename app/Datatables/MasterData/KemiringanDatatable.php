...
class KemiringanDatatable extends DataTable
{
    public function dataTable($query)
    {
        return DataTables::of($query)
            ...
            ->addColumn('action', function ($data) {
                ...
                if (Gate::check('kemiringan-U')) {
                    $action .= $edit;
                }
            
                if (Gate::check('kemiringan-D')) {
                    $action .= $delete;
                }
            
                return $action;
            })
            ->rawColumns(['kota','id_kemiringan_wilayah', 'luas', 'action']);
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('id_kemiringan_wilayah')->title('Kemiringan'),
