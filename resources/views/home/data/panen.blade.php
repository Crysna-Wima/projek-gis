          ...
          <div class="col-lg-6">
            <div class="banner_content text-center">
              ...
              <div class="page_link">
                ...
                <a href="course-details.html">Data Panen</a>
              </div>
            </div>
          </div>
        </div>
...
<section class="course_details_area section_gap">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 course_details_left">
                <div class="main_image">
                    <img class="img-fluid" src="{{ asset("assets-user/img/courses/panen01.png") }}" alt="">
                </div>
            </div>
                ...
                <ul>
                    <li>
                        <a class="justify-content-between d-flex" href="#">
                            <p>Jumlah Hasil Panen</p>
                            <span class="or">50.000.000</span>
                        </a>
                    </li>
                    <li>
                        <a class="justify-content-between d-flex" href="#">
        ...
        <div class="content_wrapper">
            <h4 class="title">PETA PERSEBARAN PANEN WILAYAH PROVINSI JAWA TIMUR</h4>
            <div class="content">
                <p>Data berikut merupakan akumulasi data panen di wilayah provinsi Jawa Timur:</p>
                <ul>
                    ...
                    <li>Data total panen dapat berubah menyesuaikan inputan data terakhir</li>
