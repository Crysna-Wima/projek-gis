          ...
          <div class="col-lg-6">
            <div class="banner_content text-center">
              ...
              <div class="page_link">
                ...
                <a href="course-details.html">Data Kabupaten/Kota</a>
              </div>
            </div>
          </div>
        </div>
...
<section class="course_details_area section_gap">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 course_details_left">
                <div class="main_image pl-5 ml-5">
                    <img class="img-fluid" src="{{ asset("assets-user/img/courses/kab-kota.jpg") }}" alt="">
                </div>
            </div>
        ...
        <div class="content_wrapper">
            <h4 class="title">PETA PERSEBARAN KABUPATEN/KOTA WILAYAH PROVINSI JAWA TIMUR</h4>
            <div class="content">
                <p>Data berikut merupakan data persebaran kabupaten/kota di wilayah provinsi Jawa Timur:</p>
                <ul>
                    ...
                    <li>Data kabupaten/kota dapat berubah menyesuaikan inputan data terakhir</li>
