...
<head>
    ...
    <style>
        ...
        .loading-spinner {
            ...
            /* Background color of the loading rectangle */
            ...
            z-index: 2;
            /* Set a high z-index value to bring the loading spinner to the front */
        }

        .loading-spinner i {
            margin-right: 5px;
            /* Adjust the spacing between the spinner and text */
            font-size: 12px;
            /* Adjust the font size as needed */
        }
...
<body data-sidebar="dark">
    ...
    <div id="layout-wrapper">
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box" style="background-color: white">
                        ...
                        <a href="/dashboard" class="logo logo-light">
                            ...
                            <span class="logo-lg">
                                <img src="{{ asset('assets-user/img/logo4.png') }}"
                                    style="width: 20%; display: inline; margin-bottom: 15px">
                                <h1 class="text-center text-warning d-inline p-2 mt-2"
                                    style="font-size: 1.5rem; font-weight: bold">PadInsight</h1>
                            </span>
                        </a>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <ul class="list-unstyled megamenu-list">
                                                <li>
                                                    <a href="#" target="_blank" key="t-lightbox">User
                                                        Manual</a>
                                                </li>
                                                <li>
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block d-lg-none ms-2">
                        <button type="button" class="btn header-item noti-icon waves-effect"
                            ...
                            <span class="badge bg-danger rounded-pill p-0"><i
                                    class="bx bx-cloud-download font-size-13 text-white "></i></span>
                        </button>
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="#" target="_blank">
                                <i
                                    class="bx bx-file bx-tada bg-primary rounded-circle font-size-16 align-middle me-1 p-1 text-white"></i>
                                <span key="t-profile">User Manual</span>
                            </a>
                            <a class="dropdown-item" href="#">
                                <i
                                    class="bx bx-file bx-tada bg-info rounded-circle font-size-16 align-middle me-1 p-1 text-white"></i>
                                <span key="t-profile">Formulir BRD</span>
                            </a>
                            <a class="dropdown-item" href="#">
                                <i
                                    class="bx bx-file bx-tada bg-success rounded-circle font-size-16 align-middle me-1 p-1 text-white"></i>
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            ...
                            @else
                                <img class="rounded-circle header-profile-user"
                                    src="{{ isset(auth()->user()->foto) ? asset('assets/images/user/' . auth()->user()->foto) : '' }}"
                                    alt="Header Avatar"
                                    onerror="this.onerror=null;this.src='{{ asset('assets/images/users/avatar-1.jpg') }}'">
                            @endif
                            <span class="d-none d-xl-inline-block ms-1"
                                key="t-henry">{{ isset(auth()->user()->first_name) ? auth()->user()->first_name : '' }}
                                {{ isset(auth()->user()->last_name) ? auth()->user()->last_name : '' }}</span>
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                data-bs-target="#ganti_password"><i
                                    class="bx bx-lock-alt font-size-16 align-middle me-1"></i> <span
                                    key="t-profile">Ganti Password</span></a>
                            <div class="dropdown-divider"></div>
        ...
        @yield('content')
        <div id="{{ __('ganti_password') }}" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                        ...
                        <div>
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group auth-pass-inputgroup">
                                    <input type="password" id="pass" minlength="8" name="n_pass"
                                        class="form-control" placeholder="Masukkan Kata Sandi" aria-label="Password"
                                        aria-describedby="password-addon" required>
                                    <button class="btn btn-info" type="button" id="password-addon"><i
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group auth-pass-inputgroup">
                                    <input type="password" id="pass_valid" minlength="8" name="c_n_pass"
                                        class="form-control" placeholder="Konfirmasi Kata Sandi" required>
                                    <button class="btn btn-info" type="button" id="pd1"><i id="icon"
                                            class="mdi mdi-eye-outline"></i></button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="btn_back" type="button" class="btn btn-danger waves-effect"
                            data-bs-dismiss="modal">Kembali</button>
                        <button id="btn_simpan" class="btn btn-primary waves-effect waves-light">Simpan</button>
                        <button style="display: none;" disabled type="button" id="submit_loading"
    ...
    {{-- <script>
        const map = L.map('map').setView([-7.506883436204239, 112.2035339417455], 4);
