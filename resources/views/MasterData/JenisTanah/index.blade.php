                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header p-2 bg-info shadow">
                            <div class="row">
                                <h4 class="font-size-15 text-white col-6 m-1"><i class="fas fa-icicles mx-3"></i>Jenis Tanah
                                </h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <ul class="nav nav-tabs" role="tablist" id="tab_jenis_tanah">
                                <li class="nav-item waves-effect waves-light" id="daftar_jenis_tanah">
                                    <a class="nav-link tab_jen active" data-bs-toggle="tab" href="#tab_daftar_jenis_tanah"
                                        role="tab" data-state="1">
                                        <span class="d-block d-sm-none"><i class="fas fa-home"></i> <span
                                                class="badge bg-danger rounded-pill"></span></span>
                                        <span class="d-none d-sm-block">Daftar Jenis Tanah</span>
                                    </a>
                                </li>
                                <li class="nav-item waves-effect waves-light" id="mapping_jenis_tanah">
                                    <a class="nav-link tab_jen" data-bs-toggle="tab" href="#tab_mapping_jenis_tanah"
                            ...
                            <div class="tab-content p-3 text-muted">
                                {{-- tab_daftar_jenis_tanah --}}
                                <div class="tab-pane fade show active" id="tab_daftar_jenis_tanah" role="tabpanel">
                                    ...
                                    @can('jenistanah-C')
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <button
                                                    class="btn btn-primary btn-sm mx-2 btn-tambah-jenistanah float-end mb-2">
                                ...
                                {{-- tab_mapping_jenis_tanah --}}
                                <div class="tab-pane fade" id="tab_mapping_jenis_tanah" role="tabpanel">
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="card-xl">
                                                <div class="card-body">
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="bg-navyblue"
                                                                            style="width: 20px; height: 20px;"></div>
                                                                        <span class="mx-2">Nitosol (Ultisols, Alfisols,
                                                                            Mollisols)</span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-3">
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="bg-chartreuse"
                                                                            style="width: 20px; height: 20px;"></div>
                                                                        <span class="mx-2">Planosol (Albaqualfs,
                                                                            Albaquults)</span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-3">
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="bg-indianred"
                                                                            style="width: 20px; height: 20px;"></div>
                                                                        <span class="mx-2">Lateritik (Oxisols, Ultisols,
                                                                            Alfisols)</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body p-4">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control input-jenistanah select2_kota" name='kota'
                                            id="kota">
                                ...
                                <div class="mb-3 row">
                                    <label for="inputPassword" class="col-sm-4 col-form-label">Jenis Tanah
                                        <strong><code>*</code></strong></label>
                                    <div class="col-sm-8">
                                        <select class="form-control input-jenistanah select2_id_jenis_tanah"
                                            name='id_jenis_tanah' id="id_jenis_tanah">
                                            <option value="">Pilih Jenis Tanah</option>
                                            @foreach ($id_jenis_tanah as $item)
                                                <option value="{{ $item->id }}">{{ $item->name }}</option>
                                            @endforeach
                            ...
                            <div class="modal-footer">
                                ...
                                @can('jenistanah-C')
                                    <button type="button" id="btn-simpan-jenistanah"
                                        class="btn btn-primary btn-simpan-jenistanah"><i
                ...
                <div class="modal fade" id="modal-edit-jenistanah" data-bs-backdrop="static" data-bs-keyboard="false"
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                        <div class="modal-content">
                            ...
                            <div class="modal-body p-4">
                                <input type="hidden" class="edit-jenistanah" name="id_jenistanah" id="id_jenistanah"
                                    value="">
                                <div class="mb-3 row">
                                    <label for="inputPassword" class="col-sm-4 col-form-label">Kota / Kabupaten
                                        <strong><code>*</code></strong></label>
                                    <div class="col-sm-8">
                                        <select class="form-control edit-jenistanah select2_edit_kota" name='edit_kota'
                                            id="edit_kota">
                                            <option value="">Pilih Kota / Kabupaten</option>
                                            @foreach ($kota as $item)
                                                <option value="{{ $item->id }}">{{ $item->name }}</option>
                                ...
                                <div class="mb-3 row">
                                    <label for="inputPassword" class="col-sm-4 col-form-label">Jenis Tanah
                                        <strong><code>*</code></strong></label>
                                    <div class="col-sm-8">
                                        <select class="form-control edit-jenistanah select2_edit_id_jenis_tanah"
                                            name='edit_id_jenis_tanah' id="edit_id_jenis_tanah">
                                            <option value="">Pilih Jenis Tanah</option>
                                            @foreach ($id_jenis_tanah as $item)
                                                <option value="{{ $item->id }}">{{ $item->name }}</option>
                                            @endforeach
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                @can('jenistanah-U')
                                    <button type="button" id="btn-edit-jenistanah"
                                        class="btn btn-primary btn-edit-jenistanah"><i
                                            class="fas fa-save mx-2"></i>Simpan</button>
                                @endcan
                            </div>
                        </div>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            // change state tab
            $(document).on("click", ".tab_jen", function() {
                        ...
                        success: function(data) {
                            ...
                            if (data.status == 'success') {
                                ...
                                data.data.forEach(function(kota) {
                                    ...
                                    var jenis_tanah = kota.jenistanah.name;
                                    var luas = kota.luas;
                                    var color = 'green';
                                    ...
                                    else if (totalJenisTanah == 17) color =
                                        'chartreuse';
                                    else if (totalJenisTanah == 18) color =
                                        'darkgoldenro';
                                    ...
                                    L.circle([kota.kota.latitude, kota.kota
                                        ...
                                        .bindPopup(
                                            `<b>${kota.kota.name}</b><br>Jenis Tanah: ${jenis_tanah}<br>Luas: ${luas} Ha`
                                        );
                                });
                            } else {
                                Swal.fire({
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data.status == 'success') {
                                ...
                                $('#edit_id_jenis_tanah').val(data.data.id_jenis_tanah).trigger(
                                    'change');
