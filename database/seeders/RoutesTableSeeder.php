...
class RoutesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            // Menu Setting
            ['permission' => '', 'middleware' => 'lang,authz', 'type' => 'view', 'method' => 'GET', 'url' => '/menusetting', 'route' => 'WEBSETTING\MenuController@index', 'guard' => 'web'],
            ...
            // Role Setting
            ['permission' => '', 'middleware' => 'lang,authz', 'type' => 'view', 'method' => 'GET', 'url' => '/rolesetting', 'route' => 'WEBSETTING\RoleController@index', 'guard' => 'web'],
            ...
            // Route Setting
            ['permission' => '', 'middleware' => 'lang,authz', 'type' => 'view', 'method' => 'GET', 'url' => '/routesetting', 'route' => 'WEBSETTING\RouteController@index', 'guard' => 'web'],
            ...
            // User Setting
            ['permission' => '', 'middleware' => 'lang,authz', 'type' => 'view', 'method' => 'GET', 'url' => '/usersetting', 'route' => 'WEBSETTING\UserController@index', 'guard' => 'web'],
            ...
            ['permission' => '', 'middleware' => 'lang,authz', 'type' => 'data', 'method' => 'GET', 'url' => '/usersetting/{uuid}', 'route' => 'WEBSETTING\UserController@show', 'guard' => 'web'],
            ...
            // Permission Setting
            ['permission' => '', 'middleware' => 'lang,authz', 'type' => 'view', 'method' => 'GET', 'url' => '/permissionsetting', 'route' => 'WEBSETTING\PermissionController@index', 'guard' => 'web'],
            ...
            //Landing Page
            ['permission' => '', 'middleware' => 'lang,authz', 'type' => 'view', 'method' => 'GET', 'url' => '/landingpage', 'route' => 'LandingPageController@index', 'guard' => 'web'],
